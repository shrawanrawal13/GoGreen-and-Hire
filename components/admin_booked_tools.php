...
$sql="SELECT bookings.end_date,bookings.id, bookings.booking_date, tools.name,bookings.tools_id, members.first_name, members.last_name,tools.availability
FROM ((Bookings
...
<html>
<head>
    <title>GoGreen&Hire - Admin Booked Tools </title>
...
<div class="w3-main" style="margin-left:150px">
    ...
    <table class="w3-table-all w3-card-4 w3-margin" style="width:90%">
        <tr class="w3-light-blue" >
            ...
            <td width="15%" align="center"><big><b>Member Name</b></big></td>
            <td width="15%" align="center"><big><b>Booking Date</b></big></td>
            <td width="20%" align="center"><big><b>Status</b></big></td>
            <td width="10%" align="center"><big><b>Fine</b></big></td>
        ...
        <?php while($row = mysqli_fetch_assoc($result)): ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-success" href="../handler/done_booking.php?tool_id=<?php echo $row['id']; ?>&accept">Done</a>
                </td>
                <td>
